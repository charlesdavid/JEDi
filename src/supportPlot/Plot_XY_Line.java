...
public class Plot_XY_Line
{
	...
	public Plot_XY_Line(String output_dir, String title, Matrix input_data)
	{
	...
	public Plot_XY_Line(String output_dir, String title, String x_ax, String y_ax, Matrix input_data)
	{
		this.out_dir = output_dir;
		this.chart_title = title;
		this.xAxis = x_ax;
	...
	{
		JFreeChart chart = ChartFactory.createXYLineChart(title, x_axis_label, y_axis_label, createDataset(col1, col2), PlotOrientation.VERTICAL, true, true, false);

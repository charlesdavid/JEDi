...
public class JEDi_Transform_Coords
	{
		final int COLS = 1;
		 ...
		 * 
		 * @param ref_conf The reference conformation
		 * @param conf     The conformation to transform
		 */
		JEDi_Transform_Coords(Matrix ref_conf, Matrix conf)
			{

...
public class JEDi_Get_Cartesian_PCA
	{
		...
		public String directory, out_dir, description, file_name_head, path, type, model;
		public int number_of_modes, number_of_atoms, ROWS, COLS;
		...
		public Matrix input_data, centered_input_data, cov, corr, pcorr, inv_cov, inv_corr, rcov, rcorr, rpcorr, r_inv_cov, r_inv_corr, top_evectors_COV, square_pca_modes_COV,
				weighted_square_pca_modes_COV, weighted_pca_modes_COV, top_evectors_CORR, square_pca_modes_CORR, weighted_square_pca_modes_CORR, weighted_pca_modes_CORR,
				pca_modes_COV, pca_modes_CORR, top_evectors_PCORR, square_pca_modes_PCORR, weighted_square_pca_modes_PCORR, weighted_pca_modes_PCORR, pca_modes_PCORR;
		 ...
		 */
		JEDi_Get_Cartesian_PCA(Matrix data, int num_modes, String dir, String des, String type_pca)
			{
		...
		private void Do_Cov_PCA(String model_pca)
			{
				...
				out_dir = directory + "JEDi_RESULTS_" + description + File.separatorChar + type + File.separatorChar + model_pca + File.separatorChar;
		...
		private void Do_Corr_PCA(String model_pca)
			{
		...
		private void Do_PCorr_PCA(String model_pca)
			{
